...
public class FxProject extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			vbox2.getChildren().addAll(txt2, b1, b2, b3, b4, b5);// Add all to vertical box.
			...
			cb.setPromptText("Choose one of the following options");
			...
			ImageView Q1 = new ImageView(
					"https://rukminim1.flixcart.com/image/416/416/jksm4y80/album/w/f/e/designer-5-x-7-photo-album-for-collection-72-photos-photo-size-original-imaf7uyzzkqnwfzk.jpeg?q=70");
			Q1.setLayoutX(700);
			Q1.setLayoutY(50);
			Q1.setFitHeight(550);
			Q1.setFitWidth(800);
